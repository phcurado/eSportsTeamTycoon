...
*/        Batch batch = new SpriteBatch();
    ...
    public boolean hasTeam(ArrayList<com.paulocurado.esportsmanager.model.Team> teams) {
    ...
    public com.paulocurado.esportsmanager.model.Team playerTeam(ArrayList<com.paulocurado.esportsmanager.model.Team> teams) {
        for(int i = 0; i < teams.size(); i++ ) {
            for(int j = 0; j < teams.get(i).getPlayers().size(); j++) {
